...
const SuccessCreateOrder: React.FunctionComponent<Props> = ({ navigation }) => {
    ...
    return (
        ...
        <View style={{alignItems:"center",marginTop:calcHeight(180)}}>
            <Text style={{color:"#212121",fontSize:calcFontSize(18),fontWeight:"bold"}}>Ваш заказ №{neworder} опубликован! </Text>
            <Text style={{color:"#212121",fontSize:calcFontSize(18),fontWeight:"300",textAlign:"center"}}>В ближайшее время с вами свяжется оператор для уточнения деталей по оплате </Text>
        <Text 
        onPress={()=>{
            dispatch(setNewOrder(""))
            navigation.navigate("Orders",{new:true})}}
        style={{textDecorationLine:"underline",color:"#FFAD40",fontSize:calcFontSize(18),fontWeight:"bold",textAlign:"center",marginTop:calcHeight(38)}}>перейти в заказы</Text>
            </View>
...
export default SuccessCreateOrder;
